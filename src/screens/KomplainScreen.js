...
export default function KomplainScreen ({navigation, route}){
    ...
    //         })
    //         axios.get(`http://192.168.43.22:8000/api/user/penjualan?email=${profile}`, headers).then(response => {
                ...
                <View>
                    ...
                    <View>
                        ...
                        >
                            ...
                            <Text style={{marginLeft: 15, fontSize: 18, marginTop: 10, color: 'black', fontWeight: 'bold'}}>Masalah apa yang kamu hadapi?</Text>
                            {
                                from == 'DELIVERY' ?
                                    <Card style={styles.card}>
                                        <TouchableOpacity onPress={() => setHasil(true)}>
                                            <View style={{marginHorizontal: 10, marginVertical: 5}}>
                                                <Text style={{color: 'black'}}>Pengiriman Terlalu Lama</Text>
                                            </View>
                                        </TouchableOpacity>
                                    </Card>
                                    :
                                    from == 'DELIVERED' ?
                                        <Card style={styles.card}>
                                            <TouchableOpacity onPress={() => navigation.navigate('PengisianKomplainScreen', {id_penjualan: (id_penjualan), subject: 'Barang Rusak/Salah'})}>
                                                <View style={{marginHorizontal: 10, marginVertical: 5}}>
                                                    <Text style={{color: 'black'}}>Barang Rusak/Salah</Text>
                                                </View>
                                            </TouchableOpacity>
                                            <TouchableOpacity onPress={() => navigation.navigate('PengisianKomplainScreen', {id_penjualan: (id_penjualan), subject: 'Pesanan Kurang Lengkap'})}>
                                                <View style={{marginHorizontal: 10, marginBottom: 5}}>
                                                    <Text style={{color: 'black'}}>Pesanan Kurang Lengkap</Text>
                                                </View>
                                            </TouchableOpacity>
                                            <TouchableOpacity onPress={() => navigation.navigate('PengisianKomplainScreen', {id_penjualan: (id_penjualan), subject: 'Pesanan Belum Sampai'})}>
                                                <View style={{marginHorizontal: 10, marginBottom: 5}}>
                                                    <Text style={{color: 'black'}}>Pesanan Belum Sampai</Text>
                                                </View>
                                            </TouchableOpacity>
                                        </Card>
                                        :
                    ...
                    }
                    {
                        hasil == true ?
                        <Card style={styles.card}>
                            <TouchableOpacity onPress={() => setHasil(false)}>
                                <View style={{marginHorizontal: 10, marginVertical: 5}}>
                                    <Text style={{color: 'black', marginBottom: 5, fontSize: 18}}>Pengiriman Terlalu Lama</Text>
                                    <Text style={{color: 'black'}}>Untuk pengiriman normalnya 3-7 hari kedepan tergantung daerah yang dituju. Namun tidak menutup kemungkinan lebih lama dari biasanya. Silahkan ditunggu hingga beberapa hari kedepan.</Text>
                                </View>
                            </TouchableOpacity>
                        </Card>
                        :
