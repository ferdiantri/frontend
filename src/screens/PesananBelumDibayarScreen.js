...
export default function PesananBelumDibayarScreen ({navigation}){
    ...
    async function onRefresh(){
        ...
        try{  
            ...
            axios.get(`http://192.168.43.22:8000/api/user/penjualan_belum_dibayar?email=${profile}`, headers).then(response => {
            ...
            if(token == null){
                ...
                try{
                    axios.get('http://192.168.43.22:8000/api/user/profile', headers).then(response => {
                        ...
                        axios.get(`http://192.168.43.22:8000/api/user/penjualan_belum_dibayar?email=${email}`, headers).then(response => {
                            console.log(response.data.barang)
                            if(response.data.error){
                                setEmpty(true);
                            }
