            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Penjualan Terkirim</h1>
                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table">
                                            <tr v-for="item in penjualan" :key="item.id_penjualan">
                                                ...
                                                <td width="10%"><router-link :to="'/detail_penjualan_terkirim/'+item.id_penjualan">Detail</router-link></td>
                                            </tr>
                                        </table>
                                    </div>
                            </div>
...
export default {
  ...
  setup() {
      const penjualan = ref([])
        onMounted(() =>{
            axios.get('http://192.168.43.22:8000/api/admin/penjualan_terkirim').then(response =>{
